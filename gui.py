...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(0, 240, 101, 21))
        ...
        self.LNEDIT_APIToken.setGeometry(QtCore.QRect(110, 240, 131, 20))
        ...
        self.CHKBOX_APIToken.setGeometry(QtCore.QRect(390, 240, 71, 21))
        ...
        self.CMBBOX_SelectProfile = QtWidgets.QComboBox(self.centralwidget)
        self.CMBBOX_SelectProfile.setGeometry(QtCore.QRect(110, 270, 131, 22))
        self.CMBBOX_SelectProfile.setEditable(True)
        self.CMBBOX_SelectProfile.setObjectName("CMBBOX_SelectProfile")
        self.PSHBTN_NewProfile = QtWidgets.QPushButton(self.centralwidget)
        self.PSHBTN_NewProfile.setEnabled(True)
        self.PSHBTN_NewProfile.setGeometry(QtCore.QRect(250, 270, 61, 23))
        self.PSHBTN_NewProfile.setObjectName("PSHBTN_NewProfile")
        self.PSHBTN_DeleteProfile = QtWidgets.QPushButton(self.centralwidget)
        self.PSHBTN_DeleteProfile.setEnabled(True)
        self.PSHBTN_DeleteProfile.setGeometry(QtCore.QRect(320, 270, 61, 23))
        self.PSHBTN_DeleteProfile.setObjectName("PSHBTN_DeleteProfile")
        self.PSHBTN_SaveSettings = QtWidgets.QPushButton(self.centralwidget)
        self.PSHBTN_SaveSettings.setGeometry(QtCore.QRect(250, 240, 61, 21))
        self.PSHBTN_SaveSettings.setObjectName("PSHBTN_SaveSettings")
        self.PSHBTN_UpdateSettings = QtWidgets.QPushButton(self.centralwidget)
        self.PSHBTN_UpdateSettings.setGeometry(QtCore.QRect(320, 240, 61, 21))
        self.PSHBTN_UpdateSettings.setObjectName("PSHBTN_UpdateSettings")
        self.label.raise_()
        self.label_2.raise_()
        ...
        self.label_4.raise_()
        self.CMBBOX_SelectProfile.raise_()
        self.PSHBTN_NewProfile.raise_()
        self.PSHBTN_DeleteProfile.raise_()
        self.line.raise_()
        self.PSHBTN_SaveSettings.raise_()
        self.PSHBTN_UpdateSettings.raise_()
        ...
        self.ACT_LoadProfile = QtWidgets.QAction(MainWindow)
        self.ACT_LoadProfile.setObjectName("ACT_LoadProfile")
        self.ACT_ExportProfile = QtWidgets.QAction(MainWindow)
        self.ACT_ExportProfile.setObjectName("ACT_ExportProfile")
        self.MN_File.addAction(self.ACT_LoadProfile)
        self.MN_File.addAction(self.ACT_ExportProfile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.PSHBTN_Update.setText(_translate("MainWindow", "Load"))
        ...
        self.PSHBTN_NewProfile.setText(_translate("MainWindow", "New"))
        self.PSHBTN_DeleteProfile.setText(_translate("MainWindow", "Delete"))
        self.PSHBTN_SaveSettings.setText(_translate("MainWindow", "Save"))
        self.PSHBTN_UpdateSettings.setText(_translate("MainWindow", "Load"))
        ...
        self.ACT_LoadProfile.setText(_translate("MainWindow", "Load Profile"))
        self.ACT_ExportProfile.setText(_translate("MainWindow", "Export Profile"))
